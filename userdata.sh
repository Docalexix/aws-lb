...
#clone it on vscode terminal
#created two Ec2 instances on aws one after the other using defalt SG and 
#and added a userdata.sh scripted to be launched when each server comes up
